...
import 'package:tribb/screens/support/track_issue.dart';
...
class SupportFormState extends State<SupportForm> {
  ...
  submitNewCase() async {
    ...
    var dataObj = {
      ...
      "Property_Name__c": property,
      "SG_Category__c": category,
      "Description": remarksValue.text,
      "ContactId": usersRef.docs[0]['SF_Id'],
      "Origin": "Phone"
    };
    var response = await CallAPIs.createPostRequest(
        'PostRequirementAPI', {'objData': dataObj});
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.only(top: 0, left: 5.0, right: 5.0, bottom: 0),
      child: SizedBox(
        ...
        child: Form(
          ...
          child: Padding(
            padding:
                const EdgeInsets.only(top: 0, left: 8.0, right: 8.0, bottom: 0),
